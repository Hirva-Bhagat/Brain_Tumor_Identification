...
augmented_path = 'C:/Users/bhaga/Desktop/6th sem project/augmented data/'
...
model.fit(x=X_train, y=y_train, batch_size=32, epochs=9, validation_data=(X_val, y_val), callbacks=[tensorboard, checkpoint])
